...
export interface MetaPayload<T = any> extends BaseSocketPayload {
    action: 'source_create' | 'source_update' | 'source_delete' | 'table_create' | 'table_update' | 'table_delete' | 'column_add' | 'column_update' | 'column_delete' | 'view_create' | 'view_update' | 'view_delete' | 'permission_update';
    payload: T;
    baseId?: string;
}
export interface UserEventPayload<T = any> extends BaseSocketPayload {
    action: 'base_update' | 'base_user_add' | 'base_user_remove' | 'base_user_update' | 'workspace_update' | 'workspace_user_add' | 'workspace_user_remove' | 'workspace_user_update';
    payload: T;
    baseId?: string;
    workspaceId?: string;
}
export type SocketEventPayload = ConnectionWelcomePayload | ConnectionErrorPayload | DataPayload | MetaPayload;
