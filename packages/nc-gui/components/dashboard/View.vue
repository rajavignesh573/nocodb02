...
const isMiniSidebarVisible = computed(() => {
  ...
  // Debug logging
  if (route.value.name?.includes('product-matcher')) {
    console.log('🔍 Mini Sidebar Debug:', {
      route: route.value.name,
      isNewSidebarEnabled: isNewSidebarEnabled.value,
      hideMiniSidebar: hideMiniSidebar.value,
      isSharedBase: isSharedBase.value,
      isMobileMode: isMobileMode.value,
      isLeftSidebarOpen: isLeftSidebarOpen.value,
      slotsHasSidebar: !!slots.sidebar,
      finalResult: result
    })
  }
